    ...
    <div class="cov-vue-date">
      ...
      <div class="datepicker-overlay" v-if="showInfo.check" @click="dismiss($event)"
        ...
        <div class="cov-date-body" :style="{'background-color': option.color ? option.color.header : '#3f51b5'}">
          ...
          <div class="button-box" style="padding-bottom: 15px; height: 60px;">
            ...
            <span style="background-color: rgb(63, 81, 181); color: white;"
                  @click="picked">{{option.buttons? option.buttons.ok : 'Ok'}}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    methods: {
      ...
      showDay: function showDay(time) {
        if (time === undefined || !Date.parse(time)) {
          ...
          this.checked.currentMoment = (0, _moment2.default)(time, this.format);
        }
        this.showOne('day');
        ...
        for (var i = 1; i <= monthDays; ++i) {
          ...
          if (i === Math.ceil((0, _moment2.default)(currentMoment).format('D')) && (0, _moment2.default)(oldtime, this.format).year() === (0, _moment2.default)(currentMoment).year() && (0, _moment2.default)(oldtime, this.format).month() === (0, _moment2.default)(currentMoment).month()) {
